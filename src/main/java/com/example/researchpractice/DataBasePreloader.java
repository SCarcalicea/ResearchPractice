...
public class DataBasePreloader {
    ...
    private SCIE_SCSIRepository scie_scsiRepository;
    private SenseRepository senseRepository;
    private CoreRepository coreRepository;
    private DBInitCheckerRepository dbChecker;
    ...
    private void insertDataIntoDB(List<Scie_ssci> inputData) {
